                    ...
                    if (changedFiles) {
                        ...
                        for (def file : changedFiles) {
                            if (file.contains("/Test")) {
                                ...
                                mail bcc: '', body: '''Hi
                                Successfully executed the code and tested ''', cc: '', from: '', replyTo: '', subject: 'Jenkins Job', to: 'sclrj123456@gmail.com'

                            } else {
                                 mail bcc: '', body: '''Hi
                                failured occur executing the code ''', cc: '', from: '', replyTo: '', subject: 'Jenkins Job', to: 'sclrj123456@gmail.com'
